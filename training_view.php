...
<?php
        ...
        if($cari==''){
            $sql="SELECT username FROM training";
        } else {
            $sql="SELECT username FROM training WHERE nama_kabupaten like '%".$cari."%'";
        }
        ...
        if($cari==''){
            $sql="SELECT * FROM training ORDER BY nama_kabupaten, nama_desa ASC LIMIT $posisi, $batas";
        } else {
            $sql="SELECT * FROM training WHERE nama_kabupaten like '%".$cari."%' ORDER BY nama_kabupaten, nama_desa ASC LIMIT $posisi, $batas";
        }
																	...
																	<tbody> 
																		<?php
        																	...
        																	while($hsl=$hasil->fetch_assoc()){
                                                                                ...
                                                                                echo "<td><a href=\"training_hapus.php?id_training=$hsl[id_training]\"><u>Hapus</u></a></td>";
																				echo '</tr>';
																			} 
																		?>
																	</tbody> 
